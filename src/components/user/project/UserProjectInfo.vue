<template>
    <el-dialog width="60%" :visible.sync="IsShow" :modal-append-to-body="false" top="10vh" :before-close="closeProject">
        ...
        <div slot="footer" class="user-project-info-button-box">
            <el-button class="animated fadeIn" v-show="!isModifying" round plain type="primary" @click="updateProject" icon="el-icon-edit-outline">修改信息</el-button>
            <el-button class="animated fadeIn" v-show="!isModifying" round plain type="success" @click="designProject" icon="el-icon-picture-outline-round">进入设计</el-button>
            <el-button class="animated fadeIn" v-show="!isModifying" round plain type="danger" @click="deleteProject" icon="el-icon-delete">删除项目</el-button>
            <el-button class="animated fadeIn" v-show="isModifying" round plain @click="submitUpdate" icon="el-icon-check">确认修改</el-button>
            <el-button class="animated fadeIn" v-show="isModifying" round plain type="warning" @click="submitUpdate(false)" icon="el-icon-close">取消修改</el-button>
        </div>
    </el-dialog>
</template>
