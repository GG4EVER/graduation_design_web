<template>
    <el-dialog :visible.sync="IsShow" top="8vh" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" @before-close="closeDialog">
        <div class="design-setting-title" slot="title">编辑多行输入框</div>
        <el-form>
            <el-form-item>
                <div slot="label" class="design-setting-label"><span class="design-setting-star">*&nbsp;</span>标题</div>
                <el-input v-model="editComponent.label" placeholder="请输入多行输入框的标题"></el-input>
            </el-form-item>
            <el-form-item>
                <div slot="label" class="design-setting-label">输入提示</div>
                <el-input v-model="editComponent.placeholder" placeholder="请输入多行输入框的输入提示"></el-input>
            </el-form-item>
            <el-form-item>
